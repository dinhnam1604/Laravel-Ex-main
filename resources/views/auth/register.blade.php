        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-10 text-center">
                    ...
                    <h2 class="text-3xl font-bold text-white mb-2">Tạo mới tài khoản</h2>
                </div>
                ...
                <div class="px-8 py-10">
                    ...
                    <form action="{{ route('auth.register') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs text-slate-500">Mật khẩu phải có ít nhất 8 ký tự</p>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="terms" class="ml-2 block text-sm text-slate-700">
                                Tôi đồng ý với <a href="#" class="text-blue-600 hover:text-blue-700 font-medium">Điều khoản dịch vụ</a> và <a href="#"
                                    class="text-blue-600 hover:text-blue-700 font-medium">Chính sách bảo mật</a>
                            </label>
                        </div>
